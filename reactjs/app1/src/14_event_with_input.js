      ...
      <div className="col-lg-4 my-3">
        <div className="card shadow">
          ...
          <div className="card-body">
            <button className="btn btn-danger w-100" onClick={()=>this.updateItem('thali')}>
              Thali -<span className="badge bg-white text-primary">{this.state.thali} </span>
            </button>
            <div className="row mt-2">
              <div className="col-6">
                <button type="button" className="btn btn-dark w-100" onClick={()=>this.updateItem('roti')} >
                  Roti -<span className="badge bg-white text-dark"> {this.state.roti} </span>
                </button>
              </div>
              <div className="col-6">
                <button type="button" className="btn btn-warning w-100" onClick={()=>this.updateItem('chas')}>
            ...
            <div className="row mt-2">
              <div className="col-6">
                <button type="button" className="btn btn-info w-100" onClick={()=>this.updateItem('papad')}> 
                  Papad -<span className="badge bg-white text-dark">{this.state.papad}</span>
                </button>
              </div>
              <div className="col-6">
                <button type="button" className="btn btn-success w-100" onClick={()=>this.updateItem('sweet')}>
