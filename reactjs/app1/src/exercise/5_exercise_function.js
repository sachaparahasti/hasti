        ...
        <div className="row align-items-center">
          <div className="col-lg-6" data-aos="fade-right">
            ...
            <p className="lead">
              ...
              and beauty. Our award-winning stylists create looks that turn
              heads.
            </p>
...
function ServiceDetail(props){
  let {name,details,onwards,icon}=props
  return(  <div
          ...
          >
            <div className="glass-card p-5 text-center text-white h-100">
              <i
                className={`fas ${icon} fa-4x mb-4`}
                style={{ color: "var(--gold)" }}
              />
              <h4 style={{ color: "#0a0909ff" }}>{name}</h4>
              <p className="mb-3" style={{ color: "#251515ff" }}>
                {details}
              </p>
              <h3 className="text-gold">{onwards}</h3>
            </div>
          </div>);
}
function Services() {
  return (
    <section id="services" className="py-5">
      <div className="container py-5">
        ...
        <ServiceDetail icon="fa-cut" name="Premium Haircut" details="Customized cut with consultation & luxury wash"  onwards="Rs 2500 onwards"/>
        <ServiceDetail icon="fa-paint-brush" name="Global Hair Color" details="Ammonia-free, long-lasting professional color"   onwards="Rs 4500 onwards" />
<ServiceDetail icon="fa-star" name="Keratin Treatment" details="Smooth, frizz-free hair for up to 6 months" onwards="Rs 8000 onwards" />
...
function Image(props){
  return(<div className="col-6 col-md-4" data-aos="fade-up" data-aos-delay={0}>
            <img
              src={props.src}
...
function Saloon(props) {
  return (
    <>
      ...
      {/* Hero */}
      <Slider site={props.site} slogan={props.slogan} />
      {/* About */}
      <AboutUs />
      {/* Services */}
      <Services />
...
root.render(
  <Saloon
    sitename="Krishn "
    site="Krishn Hair Saloon"
    slogan="Har din, perfect hair day"
  />
);
